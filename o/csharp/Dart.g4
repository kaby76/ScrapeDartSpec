...
@parser::members {
  ...
  protected Stack<bool> asyncEtcAreKeywords = new Stack<bool>();
...
@lexer::members{
  ...
  public Stack<int> braceLevels = new Stack<int>();
...
identifierNotFUNCTION
    ...
    |    { asyncEtcPredicate(this.CurrentToken.Type) }? (AWAIT|YIELD)
    ;
